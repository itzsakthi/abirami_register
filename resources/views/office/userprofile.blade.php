...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> 
    ...
    <div class="button-row" style= "text-align: end;">
        ...
        <button type="button" id="saveAsExcel" class="btn btn-success excel" style=" margin-right:30px;" >Export Excel</button>           
                            ...
                            <div class="tools">
                                ...
                                <div class="grid-container">
                                            ...
                                            <div class="grid-flex">
                                                <div class="grid-item bold "style="text-align:left">
                                                    <div class="detailed-card">
                                                        ...
                                                        <img src="{{ asset('images/avatar2.jpg') }}" style="height: 128px; width: 128px;" alt="Avatar Image">
                                                    ...
                                                    <div class="detailed-card1">
                                                        <div class="detailed-card-content">
                                                            <div class="detailed-card-grid">
                                                                <div>
                                                                    <p>
                                                                        <h2 style="font-size: 20px;" class="detailed-card-title">
                                                                            Overall Outstanding.
                                                                        </h2>
                                                                        pullivari & yellam
                                                                    </p>
                                    ...
                                    <div class="grid-row" style="background-color: rgb(236, 236, 236);">
                                        <div class="grid-item col-span-2" style="font-size: 36px; font-weight: bold;">PULLI VARI</div>
                                        <div class="grid-item plus-icon"><button type="button" class="btn btn-success vari" >SHOW</button></div>           
                                    </div>
                                        ...
                                        <div class="pullivari" style="display:none;">
                                                    <div class="bg-gradient-success shadow-primary relative border-radius-lg pt-4 pb-3">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                                <h6 style="font-size: 12px;" class="text-white text-capitalize ps-3">PULLI VARI</h6>
                                                                <div class="d-flex justify_content-center align-item-baseline">
                                                                    ...
                                                                    <div  id="creativebt-submit" data-tooltip="Price:-$0" class="creativebt" style='margin-right:20px;'>
                                                                        <div class="creativebt-wrapper">
                                                                            <div class="creativebt-text">Pay</div>
                                                                            <span class="creativebt-icon">
                                                                                <svg viewBox="0 0 24 24" class="bi bi-cart2"  height="16" width="16">
                                                                                    <path
                                                        ...
                                                        <div class="input-group input-group-dynamic mt-3 mb-4" >
                                                            ...
                                                            <div class="table-responsive" style="width:100%; max-height: 400px; overflow-y: auto;" id="table_scroll">
                                                                <table class="table align-items-center mb-0" style="width:100%;text-align:center;"  id="mytable">
                                                                        <form method="POST" id="pullivaripay" enctype="multipart/form-data">
                                                                        @csrf
                                                                                ...
                                                                                <th class="">
                                                                                    <div class="input-group input-group-static">
                                                                                        <label class="form-check-label"> 
                                                                                            <input type="checkbox" class="amt-checkbox form-check-input me-2" style="border: 1px solid pink;" 
                                                                                                id="checkAll"   
                                                                                                checked />
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            @php $sno=1;$pending_pulliamt_yellamamt=0;$pending_pullivari=0;@endphp
                                                                            @foreach($finalData as $item)
                                                                                <tr>
                                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $sno }}</p></td>
                                                                                    @if($item['status']=='not paid')
                                                                                    <td>
                                                                                        @php $pending_pulliamt_yellamamt+=$item['amt'];$pending_pullivari+=$item['amt'];  @endphp
                                                                                        <div class="input-group input-group-static mb-2">
                                                                                            <label class="form-check-label"> 
                                                                                            <input type="checkbox" class="amt-checkbox form-check-input me-2" style="margin-left:25%;border: 1px solid pink;"  
                                                                                                name="selected_amts[{{$item['year']}}]"
                                                                                                data-year="{{$item['year']}}" 
                                                                                                value="{{$item['amt']}}" 
                                                                                                checked />
                                                                                                <a href="{{ route('income_entry', ['inc_type' => 1, 'pulliid' => $item['pulliid'] ]) }}" id="pulli_checkAll" class="pulli_checkbox_link">
                                                                                    ...
                                                                                    @else
                                                                                    <td>  
                                                                                        <p id="pulli_checkAll" class="text-xs checkboxfont-weight-bold " style="margin-left:-45% " >
                                                                                            <i class="fa fa-check-circle text-success">{{ $item['status'] }}</i>    
                                                                                        </p>
                                                                                    </td>
                                                                                    @endif
                                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $item['year'] }}</p></td>
                                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $item['pulliid'] }}</p></td>
                                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $item['name'] }}</p>
                                                                                    </td>
                                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $item['amt'] }}</p>
                                                                                    </td>
                                                                                    <td>  
                                                                                        <a href="{{route('receipt', ['id' => $item['pulliid'],'paytotxt'=>$item['year']])}}" target="_blank">
                                                                        ...
                                                                        <input type="hidden" id="itype" name="itype" value='PULLIVARI'>
                                                                        <input type="hidden" value="{{ $iddata->pulliid}}" id="vari_id" name="vari_id">
                                                                        <input type="hidden" value="{{ $iddata->name}}" id="vari_name" name="vari_name">
                                                                        <input type="hidden" value="{{ $iddata->whatsappnumber}}"  id="vari_no" name="vari_no">
                                                                        <input type="hidden" value="{{ $iddata->address}}"  id="vari_address" name="vari_address"> 
                                                                        <input type="hidden" value="paid for-{{ $iddata->pulliid}}"  id="vari_DESCRIPTION" name="vari_DESCRIPTION">
                                                                        <input type="hidden" value="" id="vari_value" name="vari_value">
                                    ...
                                    <div class="grid-row" style="background-color: rgb(255, 255, 255);">
                                        <div class="grid-item col-span-2" style="font-size: 36px; font-weight: bold;">YELLAM</div>
                                        <div class="grid-item plus-icon"><button type="button" class="btn btn-success yel" >SHOW</button></div>
                                    </div>

                                        <!-- Yellam Table -->
                                        <form id="yellampay" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="Yellam"  style="display:none">
                                                <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <h6 style="font-size: 12px;" class="text-white text-capitalize ps-3">YELLAM</h6>
                                                            ...
                                                            <div class="pending_container">
                                                                <div class="pending_content">
                                                                    <div class="content__container">
                                                                            <span>Outstanding</span>
                                                                        <ul class="content__container__list">
                                                                            <li class="content__container__list__item ybalance">₹</li>
                                                                            <li class="content__container__list__item ybalance">ரூ</li>
                                                                            <li class="content__container__list__item ybalance">INR</li>
                                                                            <li class="content__container__list__item ybalance">₹</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="input-group input-group-dynamic mt-2 mb-4" >
                                                    ...
                                                    <div class="table-responsive"  style="width:100%; max-height: 400px; overflow-y: auto;"  id="table_scroll">
                                                        <table class="table align-items-center mb-0" style="width:100%;text-align:center"  id="mytable2">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">SNO</th>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Pulli ID</th>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Yellam product</th>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">NAME</th>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">AMOUNT</th>
                                                                ...
                                                                @if(!$room->nameguest)
                                                                    @php $pending_pulliamt_yellamamt+= ($y_amt); @endphp
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td> <p class="text-xs font-weight-bold mb-0"> @php echo($room->value - $room->paidtotal) @endphp</p></td>
                                                                            ...
                                                                            @if(($y_amt !=0) || $room->payment!='paid')
                                                                                ...
                                                                                <td>
                                                                                    <div class="input-group input-group-static mb-2">
                                                                                        <label class="form-check-label"> 
                                                                                        <input type="checkbox" class="yellam-amt-checkbox form-check-input me-2" style="margin-left:25%;border: 1px solid pink;"  
                                                                            ...
                                                                            @else
                                                                                <td>  
                                                                                    <p class="text-xs checkboxfont-weight-bold " style="margin-left:-45% " >
                                                                                        <i class="fa fa-check-circle text-success">paid</i>    
                                                                                    </p>
                                                                                </td>
                                                                            @endif
                                                                            <td>  
                                                                                <a href="{{route('receipt', ['id' => $room->id])}}" target="_blank">
                                                                                    <i class="fa fa fa-print text-success"></i> 
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                            ...
                                            <div class="Yellam_external"  style="display:none">
                                                <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <h6 style="font-size: 12px;"  class="text-white text-capitalize ps-3">Referrals YELLAM</h6>
                                                        <div class="d-flex justify_content-center align-item-baseline gap-1">
                                                            <div class="pending_container">
                                                                <div class="pending_content">
                                                                    <div class="content__container">
                                                                        ...
                                                                        <ul class="content__container__list">
                                                                            <li class="content__container__list__item rybalance">₹</li>
                                                                            <li class="content__container__list__item rybalance">ரூ</li>
                                                                            <li class="content__container__list__item rybalance">INR</li>
                                                                            <li class="content__container__list__item rybalance">₹</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div  id="ref_yellam-submit" data-tooltip="Price:-$0" class="creativebt" style='margin-right:20px;'>
                                                                <div class="creativebt-wrapper">
                                                                    <div class="creativebt-text">Pay</div>
                                                                    <span class="creativebt-icon">
                                                                        <svg viewBox="0 0 24 24" class="bi bi-cart2"  height="16" width="16">
                                                ...
                                                <div class="input-group input-group-dynamic mt-2 mb-4" >
                                                    ...
                                                    <div class="table-responsive" style="width:100%; max-height: 400px; overflow-y: auto;"  id="table_scroll">
                                                        <table class="table align-items-center mb-0" style="width:100%;text-align:center"  id="mytable3">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">SNO</th>
                                                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Pulli ID</th>
                                                                    ...
                                                                    <th class="">
                                                                        <div class="input-group input-group-static">
                                                                            <label class="form-check-label"> 
                                                                                <input type="checkbox" class="ref_yellam-checkbox form-check-input me-2" style="border: 1px solid pink;" 
                                                                                    id="ref_yellam-checkAll"   
                                                                                    checked />
                                                                                    <p class="text-xs font-weight-bold mb-0" >
                                                                                        <i class="text-uppercase text-secondary text-xs font-weight-bolder fa fa-rupee ">pay</i>    
                                                                                    </p>    
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @php $y_amt=$room->value - $room->paidtotal ; @endphp
                                                                    <tr>
                                                                        ...
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->pulliid }}</p></td>
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->things }}</p></td>
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->name }} 
                                                                            || {{$room->nameguest}} <i class="text-success">(guest)</i></p>
                                                                        </td>
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->value }}</p></td>
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> @php echo($room->value - $room->paidtotal) @endphp</p></td>
                                                                        <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->paidtotal }}</p></td>
                                                                        @if((($room->value -$room->paidtotal) !=0) || $room->payment!='paid')
                                                                        
                                                                            <td>
                                                                                
                                                                                <div class="input-group input-group-static mb-2">
                                                                                    <label class="form-check-label"> 
                                                                                    <input type="checkbox" class="ref_yellam-amt-checkbox form-check-input me-2" style="margin-left:25%;border: 1px solid pink;"  
                                                                                        name="selected_yellam_amts[{{$room->id}}]"
                                                                                        
                                                                                        value="{{$y_amt}}" 
                                                                                        checked />
                                                                                        
                                                                                        <a href="{{ route('income_entry', ['inc_type' => 4, 'pulliid' => $item['pulliid'] ]) }}" class="pulli_checkbox_link">
                                                                                            <p class="text-xs font-weight-bold mb-0" >
                                                                                                <i class="fa fa-rupee  text-warning">pay</i>    
                                                                                            </p>   
                                                                                        </a>
                                    ...
                                    <div class="grid-row" style="background-color: rgb(236, 236, 236);">
                                        <div class="grid-item col-span-2" style="font-size: 36px; font-weight: bold;">DONATION</div>
                                        <div class="grid-item plus-icon"><button type="button" class="btn btn-success don" >SHOW</button></div>
                                    </div>
                                        ...
                                        <div class="donation"  style="display:none">
                                            <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                                <h6 style="font-size: 12px;"  class="text-white text-capitalize ps-3">Donation</h6>
                                            </div>
                                            <div class="input-group input-group-dynamic mt-3 mb-4" >
                                                <div class="input-group input-group-outline col-6">
                                                ...
                                                <div class="table-responsive" style="width:100%; max-height: 400px; overflow-y: auto;" id="table_scroll">
                                                    <table class="table align-items-center mb-0" style="width:100%;text-align:center" id="mytable1">
                                                    <thead>
                                                            <tr>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">SNO</th>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Pulli ID</th>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Donation Name</th>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Donation Type</th>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">AMOUNT</th>
                                                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Print</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @php $ids1 = $data->firstItem();$sno=1; @endphp
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->ref_id }}</p>
                                                                    </td>
                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->ref_txt }}</p></td>
                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->pay_mode }}</p></td>
                                                                    <td> <p class="text-xs font-weight-bold mb-0"> {{ $room->amount }}</p>
                                                                    </td>
                                                                    <td>  
                                                                        <a href="{{route('receipt', ['id' => $room->id,'donation'=>'{success}'])}}" target="_blank">
                                                                            <i class="fa fa fa-print text-success"></i> 
                                                                        </a>
                                                                    </td>
                                                                </tr>

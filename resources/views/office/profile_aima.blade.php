...
<head>
    ...
    <meta name="keywords" content="<?php echo $title; ?> - Portfolio Template">
    <meta name="description" content="<?php echo $title; ?> - Portfolio Template">
    <!-- title -->
...
<body data-spy="scroll" data-target="#navbar-collapse-toggle" data-offset="70">
    ...
    <div class="mob-header">
        <div class="d-flex">
            <div class="navbar-brand">
                <a class="logo-text" href="https://pxdraft.com/themeforest/<?php echo $title; ?>/index.html">
                    <?php echo $title; ?>
                </a>
            </div>
    ...
    <header class="header-left" id="navbar-collapse-toggle">
        ...
        <ul class="nav">
            <li>
                <a class="nav-link" href="index-01.html#home">
                    <i class="fas fa-house-damage"></i>
                    <span>Home</span>
                </a>
            </li>
            <li>
                <a class="nav-link" href="index-01.html#about">
                    <i class="far fa-address-card"></i>
                    <span>About Me</span>
                </a>
            </li>
            <li>
                <a class="nav-link" href="index-01.html#services">
                    <i class="fas fa-concierge-bell"></i>
                    <span>Services</span>
                </a>
            </li>
            <li>
                <a class="nav-link" href="index-01.html#work">
            ...
            <li>
                <a class="nav-link" href="index-01.html#contactus">
    ...
    <main class="main-left">
                ...
                <div class="row sm-m-25px-b m-35px-b">
                    <div class="col-md-12">
                        <div class="section-title">
                            <h3 class="dark-color text-uppercase">{{$data->company_name}}</h3>
                            <p class="text-uppercase small">{{ $data->remarks }}</p>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-5 m-15px-tb">
                        <div class="about-me-img box-shadow">
                            <img src= "{{ asset('images/profile/')}}/{{$data->image}}" title="" alt="">
                            <div class="nav social-icon">
                                <a href="index-01.html#"><i class="fab fa-facebook-f"></i></a>
                                <a href="index-01.html#"><i class="fab fa-twitter"></i></a>
                                <a href="index-01.html#"><i class="fab fa-instagram"></i></a>
                                <a href="index-01.html#"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7 m-15px-tb">
                        <div class="about-me">
                            ...
                            <div class="btn-bar">
                                <a class="m-btn m-btn-theme" href="#">Download Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- End fun -->
        <!-- resume -->
        <section style="display:none;" id="services" class="section gray-bg">
            <div class="container">
                <div class="row sm-m-25px-b m-35px-b">
                    <div class="col-md-12">
                        <div class="section-title">
                            <h3 class="dark-color text-uppercase">My Services</h3>
                            <p class="text-uppercase small">A Lead UX & UI designer based in <?php  echo $dist;  ?></p>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <!-- End resume -->
        <!-- Work -->
        <section style="display:none;" id="work" class="section">
            <div class="container">
                <div class="row sm-m-25px-b m-35px-b">
                    <div class="col-md-12">
                        <div class="section-title">
            ...
            <div class="container">
                <div class="portfolio-content lightbox-gallery">
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-1.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
                            </div>
                            <a class="link-overlay" href="index-01.html#"></a>
                        </div>
                    </div> <!-- grid item -->
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-6.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
                    ...
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-2.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
                    ...
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-3.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
                    ...
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-4.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
                    ...
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            <div class="portfolio-img">
                                <img src= "{{ asset('static/img/portfolio-5.jpg')}}" title="" alt="">
                            </div>
                            <div class="portfolio-info">
                                <h5>Our Photography</h5>
                                <span>Design</span>
        ...
        <!-- End work -->
        <!-- Testiminails -->
        <section class="section gray-bg" style="display:none;">
            <div class="container">
                <div class="row sm-m-25px-b m-35px-b">
                    <div class="col-md-12">
                        <div class="section-title">
                ...
                <div class="owl-carousel" data-items="2" data-nav-dots="true" data-md-items="2" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="30">
                    ...
                    <div class="testimonial-col-01">
                        <div class="media">
                            <div class="img">
                                <img src= "{{ asset('static/img/team-1.jpg')}}" title="" alt="">
                            </div>
                    ...
                    <div class="testimonial-col-01">
                        <div class="media">
                            <div class="img">
                                <img src= "{{ asset('static/img/team-2.jpg')}}" title="" alt="">
                            </div>
                            <div class="media-body p-25px-l">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <div class="tc-info">
                    ...
                    <div class="testimonial-col-01">
                        <div class="media">
                            <div class="img">
                                <img src= "{{ asset('static/img/team-3.jpg')}}" title="" alt="">
                            </div>
                            <div class="media-body p-25px-l">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <div class="tc-info">
                    ...
                    <div class="testimonial-col-01">
                        <div class="media">
                            <div class="img">
                                <img src= "{{ asset('static/img/team-4.jpg')}}" title="" alt="">
                            </div>
                            <div class="media-body p-25px-l">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <div class="tc-info">
        ...
        <!-- End Testiminails -->
        <!-- Blog -->
        <section id="blog" class="section white-bg" style="display:none;">
            <div class="container">
                <div class="row sm-m-25px-b m-35px-b">
                    <div class="col-md-12">
                        <div class="section-title">
                ...
                <div class="row">
                    <div class="col-lg-4 m-15px-tb">
                        <div class="blog-grid">
                            ...
                            <div class="blog-gird-info">
                                ...
                                <h5><a href="index-01.html#">Make your Marketing website</a></h5>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                <div class="btn-grid">
                                    <a class="m-btn-link" href="index-01.html#">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- col -->
                    <div class="col-lg-4 m-15px-tb">
                        <div class="blog-grid">
                            <div class="blog-grid-img">
                                <a href="index-01.html#">
                                    <img src= "{{ asset('static/img/blog-2.jpg')}}" title="" alt="">
                                </a>
                            </div>
                            <div class="blog-gird-info">
                                <div class="b-meta">
                    ...
                    <div class="col-lg-4 m-15px-tb">
                        <div class="blog-grid">
                            <div class="blog-grid-img">
                                <a href="index-01.html#">
                                    <img src= "{{ asset('static/img/blog-3.jpg')}}" title="" alt="">
                                </a>
                            </div>
                            <div class="blog-gird-info">
                                <div class="b-meta">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 m-10px-tb">
                    <div class="nav justify-content-center justify-content-md-start">
                        ...
                        <a href="index-01.html#"><i class="fab fa-instagram"></i></a>
                        <a href="index-01.html#"><i class="fab fa-linkedin-in"></i></a>
                        <a href="index-01.html#"><i class="fab fa-pinterest"></i></a>
                    </div>
                </div>
                <div class="col-md-6 m-10px-tb text-center text-md-right">
                    <p>© 2024 copyright Vplan</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- end jquery -->
    <!-- appear -->
    <script src="{{ asset('static/plugin/appear/jquery.appear')}}"></script>
    <!-- end appear -->
    <!--bootstrap-->
    ...
    <script src="{{ asset('static/js/mail_send.js')}}"></script>
    <!-- end -->
    <!-- end body -->
